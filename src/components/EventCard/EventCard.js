...
const EventCard = (props) => {
  ...
  return (
    <a
      href={`https://smash.gg/${props.event.slug}`}
      target="_blank"
      rel="noreferrer"
    >
      <div
      ...
      >
        ...
        <div className={styles["description"]}>
          ...
          <h3>
            {props.event.city}, {props.event.addrState}
          </h3>
          <h3>
            <Moment unix format="MMMM Do">
              {props.event.startAt}
            </Moment>{" "}
            -{" "}
            <Moment unix format="MMMM Do">
        ...
        <h3 className={styles["attendees"]}>
          Attendees:
          <p>
            {props.event.numAttendees !== null
              ? props.event.numAttendees
              : "TBD"}
          </p>
        </h3>
      </div>
